...
void CPedestrianDetection::grad1(float *I, float *Gx, float *Gy, int h, int w, int x) {
...
void CPedestrianDetection::grad2(float *I, float *Gx, float *Gy, int h, int w, int d) {
...
float* CPedestrianDetection::acosTable() {
...
void CPedestrianDetection::gradMagNorm(float *M, float *S, int h, int w, float norm) {
...
void CPedestrianDetection::gradHist(float *M, float *O, float *H, int h, int w,
...
float* CPedestrianDetection::hogNormMatrix(float *H, int nOrients, int hb, int wb, int bin) {
...
void CPedestrianDetection::hogChannels(float *H, const float *R, const float *N,
...
void CPedestrianDetection::hog(float *M, float *O, float *H, int h, int w, int binSize,
...
void CPedestrianDetection::fhog(float *M, float *O, float *H, int h, int w, int binSize,
