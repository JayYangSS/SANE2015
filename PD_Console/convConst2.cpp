...
void CPedestrianDetection::convBoxY( float *I, float *O, int h, int r, int s ) {
...
void CPedestrianDetection::convBox(float *I, float *O, int h, int w, int d, int r, int s) {
...
void CPedestrianDetection::conv11Y(float *I, float *O, int h, int side, int s) {
...
void CPedestrianDetection::conv11(float *I, float *O, int h, int w, int d, int side, int s) {
...
void CPedestrianDetection::convTriY(float *I, float *O, int h, int r, int s) {
...
void CPedestrianDetection::convTri(float *I, float *O, int h, int w, int d, int r, int s) {
...
void CPedestrianDetection::convTri1Y(float *I, float *O, int h, float p, int s) {
...
void CPedestrianDetection::convTri1(float *I, float *O, int h, int w, int d, float p, int s) {
...
void CPedestrianDetection::convMaxY(float *I, float *O, float *T, int h, int r) {
...
void CPedestrianDetection::convMax(float *I, float *O, int h, int w, int d, int r) {
